---
title: "从企业数据到智能体生产力：MOI 5.0 正式开启公测"
author: MatrixOrigin
description: "MatrixOne Intelligence 5.0 正式开启公测，提供 MatrixOne 云数据库、Genesis 模型服务和 AI Studio，邀请企业与开发者带着真实业务需求参与体验。"
...
# 从企业数据到智能体生产力：MOI 5.0 正式开启公测

我们很高兴地宣布，MatrixOne Intelligence（以下简称 MOI）5.0 今日正式开启公测，面向企业与开发者开放注册。从企业数据准备、模型调用到智能体构建，我们邀请你带着真实的业务需求，体验 MOI 5.0 的全新能力。

在矩阵起源的官网上完成注册并激活账号，即可获得价值相当于 100 元人民币的 1,000 Credit 体验额度。公测期间，我们尤其期待听到你的使用感受：哪些能力帮你解决了问题，哪些环节还不够顺畅，还有哪些需求尚未满足。你的反馈，将帮助我们发现问题、明确改进方向，共同把 MOI 打磨得更好。
...
在矩阵起源的官网上**[点击注册 MOI](https://moi.matrixorigin.cn/)**，完成注册并激活账号，即可获得 **1,000 Credit 体验额度**。

MatrixOne、Genesis 与 AI Studio 共用一套账户。登录后，你可以根据需求选择相应产品，开始体验：
...
为了帮助大家充分体验 MOI，我们准备了注册、反馈、签到与邀请奖励：

| 参与方式 | 奖励规则 |
|---|---|
| 注册激活 | 首次注册并激活账号，即得 **1,000 Credit**，价值相当于人民币 100 元 |
| 提交有效反馈 | 通过页面右侧「反馈」入口提交问题，经判定有效后，获得 **200 Credit** |
| 每日签到 | 注册后 20 天内，每日签到可得 **100 Credit** |
| 邀请好友 | 好友通过你的邀请链接注册并激活后，你与好友各得 **500 Credit**，最多邀请 3 人 |

平台各计费项以 Credit 计价，具体价格可在计费中心「产品定价」查看。

### 比体验更进一步，把你的反馈告诉我们

我们非常希望了解：产品能否解决你的问题，还有哪些地方需要打磨。

无论是数据接入失败、解析结果不准确、模型调用不顺畅，还是智能体没有完成预期任务，都欢迎通过页面右侧的 **「反馈」** 入口告诉我们。操作上的困惑、功能上的建议，以及尚未被满足的业务需求，同样值得留下。

提交反馈时，尽量说明**你想完成什么任务、进行了哪些操作，以及预期结果和实际结果的差异**；如有相关截图，也可以一并提供。这些信息能帮助我们更快定位问题，让改进更贴近你的实际需求。

**每一条有效反馈，都是对 MOI 的一次帮助。200 Credit 是我们的感谢，也希望支持你继续探索和验证。**
